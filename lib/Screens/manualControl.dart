...
class ManualControl extends StatefulWidget {
  ...
  const ManualControl({this.server});
...
class _ChatPage extends State<ManualControl> {
        ...
        child: Column(
          children: <Widget>[
            ...
            TextButton(
              ...
              child: ClipOval(child: Icon(Icons.arrow_circle_up_outlined, size: 50,)),
            ),
            SizedBox(height: 10),
            Container(
                ...
                child: Row(
                  children: [
                    TextButton(
                      ...
                      child: ClipOval(child: Icon(Icons.arrow_circle_left_outlined)),
                    ),
                    TextButton(
                      onPressed: isConnected ? () => _sendMessage('4') : null,
                      child: ClipOval(child: Icon(Icons.stop_circle)),
                    ),
                    TextButton(
                      onPressed: isConnected ? () => _sendMessage('2') : null,
                      child: ClipOval(child: Icon(Icons.arrow_circle_right_outlined)),
                    ),
                  ],
                ),
              ),
            ...
            TextButton(
              ...
              child: ClipOval(child: Icon(Icons.arrow_circle_down_outlined, size: 50,)),
            ),
            // Flexible(
            //   child: ListView(
